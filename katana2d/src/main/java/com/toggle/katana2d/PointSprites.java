...
public class PointSprites {
    ...
    public void draw(float[] data, float x, float y, float angle, int numPoints) {
        ...
        GLES20.glVertexAttribPointer(mRenderer.mPointSpritePositionHandle, 2,
                GLES20.GL_FLOAT, false, BYTES_PER_POINT, mPointSpriteVertexBuffer);
        mPointSpriteVertexBuffer.position(2);
        GLES20.glVertexAttribPointer(mRenderer.mPointSpriteColorHandle, 4,
                GLES20.GL_FLOAT, false, BYTES_PER_POINT, mPointSpriteVertexBuffer);
        mPointSpriteVertexBuffer.position(2 + 4);
        GLES20.glVertexAttribPointer(mRenderer.mPointSpriteSizeHandle, 1,
                GLES20.GL_FLOAT, false, BYTES_PER_POINT, mPointSpriteVertexBuffer);
